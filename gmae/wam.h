 ...
 */
struct column {
	int32_t numchn; /**< number of channels in this column */
	int32_t *chan;  /**< list of numchn channels */
};
...
struct row {
	...
	int32_t bpm;    /**< bpm for this row */
	int32_t sngspd; /**< sngspd for this row */
	int32_t patpos; /**< this row number (position in pattern) */
	int32_t sngpos; /**< position in song */

	/* the following are generated by the program */
	int32_t ticpos;  /**< tick count up to this point */
	int32_t ticprt;  /**< how many ticks into the group this row is */
	int32_t ticgrp;  /**< total # ticks in a group (4 rows) */
	int32_t line;    /**< 0 = no line, 1 = regular line, 2 = pattern start */
	int32_t patnum;  /**< the pattern this row is in */
 ...
 */
struct wam {
	int32_t num_cols;            /**< number of columns in the song,
				      * <= mod->numchn
				      */
	int32_t num_tics;            /**< number of ticks in the song */
	int32_t num_pats;            /**< number of patterns */
	int32_t num_rows;            /**< number of rows */
